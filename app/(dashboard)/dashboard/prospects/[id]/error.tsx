    ...
    <div className="flex items-center justify-center min-h-[400px]">
      <Card className="max-w-md w-full border-destructive/20 shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">Erreur de chargement du prospect</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6 text-center">
          <p className="text-sm text-muted-foreground">
            Nous n'avons pas pu charger les détails de ce prospect. 
            Cela peut arriver si la table n'existe pas ou si la colonne "description" est manquante.
          </p>
          ...
          <div className="pt-4 border-t">
            <p className="text-xs text-muted-foreground flex items-center justify-center gap-2">
              ...
              Vérifiez <code className="bg-muted px-1 rounded">final_repair.sql</code>
            </p>
          </div>
        </CardContent>
      </Card>
